        ...
        return function (Shipping) {
            return Shipping.extend({
                ...
                shippingMethodObserver: function (method) {
                    if (method && this.isFormInline && !shippingRegistry.savedAddress && !_.isEqual(this.previousShippingMethodData, method)) {
                ...
                triggerShippingDataValidateEvent: function () {
                    var isAmazonActive = $('.payment-method.amazon-payment-method._active');
                    /*
                     If Amazon Pay is enabled, then validation is not necessary for Shipping and custom_attributes,
                      because validation takes place on the Amazon side:
                      vendor/amzn/amazon-pay-module/view/frontend/web/js/view/shipping.js:75
                     */
                    if (isAmazonActive.length < 1) {
