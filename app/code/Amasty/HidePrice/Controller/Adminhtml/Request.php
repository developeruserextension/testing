...
{
    const CURRENT_REQUEST_MODEL = 'amasty_hideprice_request_model';
    /**
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Amasty_HidePrice::request';
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu(self::ADMIN_RESOURCE)
            ->_addBreadcrumb(__('Amasty Hide Price'), __('Requests'));
