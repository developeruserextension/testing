        ...
        if ($context->getVersion() && version_compare($context->getVersion(), '1.5.2', '<')) {
            ...
            try  {
                ...
                if ($directory->isExist('code/Amasty/PageSpeedOptimizer/Model/Output/MoveFontProcessor.php')) {
                    echo "\nWARNING: This update requires removing folder app/code/Amasty/PageSpeedOptimizer.\n"
                        . "Remove this folder and unpack new version of package into app/code/Amasty/PageSpeedOptimizer.\n"
