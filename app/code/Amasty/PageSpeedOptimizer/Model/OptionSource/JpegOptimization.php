    ...
    */
    ...
    const TOOLS = [
        self::JPEGOPTIM => [
            ...
            'command' => 'jpegoptim --all-progressive --strip-xmp --strip-com --strip-exif --strip-iptc %f',
            'check' => [
        ...
        self::JPEGOPTIM_90 => [
            ...
            'command' => 'jpegoptim --all-progressive --strip-all -m 90 %f',
            'check' => [
                'command' => 'jpegoptim --help',
                'result' => 'Usage: jpegoptim'
            ]
        ...
        self::JPEGOPTIM_80 => [
            ...
            'command' => 'jpegoptim --all-progressive --strip-all -m 80 %f',
            'check' => [
                'command' => 'jpegoptim --help',
                'result' => 'Usage: jpegoptim'
            ]
        ...
        self::NEW_OPTIMIZATION_TOOL => [
            ...
            'command' => 'command for Optimization Tool. %f is placeholder for filename',
            'check' => [
                'command' => 'jpegoptim --help',
